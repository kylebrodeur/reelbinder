...
ReelBinder software and original ReelBinder identity artwork: Copyright (c) 2026 Kyle Brodeur. Distributed under the MIT License in `LICENSE`.

The original identity artwork consists of the ReelBinder app icons, maskable icons, Apple touch icon, favicon variants, brand mark, and Open Graph images in `public/app-icons/`, `public/brand/`, and the corresponding files in `public/`.

Third-party dependencies and tools retain their own copyright, licenses, and notices. The ReelBinder license does not relicense those dependencies or grant trademark rights.
