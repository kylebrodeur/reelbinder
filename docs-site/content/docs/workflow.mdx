...
Use discussions and Assistant to develop specific, editable direction. to develop specific, editable direction. Review proposals before applying them. A generation request should have the intended reference, prompt and provider connection selected.
